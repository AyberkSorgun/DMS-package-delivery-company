<?php
	...
	if ($qsql and $result and $result2 and $master_query){
		...
		if ($_POST['package2'] == "package2"){
			...
			$sql = "INSERT INTO package VALUES ('".$cust_ID."','".$package_ID."','".$wtype2."','".$ttype2."', '".$content2."', '".floatval($weight2)."')";
		...
		if ($_POST['package3'] == "package3"){
			...
			$sql = "INSERT INTO package VALUES ('".$cust_ID."','".$package_ID."','".$wtype3."','".$ttype3."', '".$content3."', '".floatval($weight3)."')";
